    ...
    return BlocListener<AuthBloc, AuthState>(
      ...
      child: Scaffold(
        ...
        body: Padding(
          ...
          child: Column(
            children: [
              const Text("If your forgot your password, enter your email and we will send you a password reset link."),
              TextField(
                keyboardType: TextInputType.emailAddress,
                autocorrect: true,
                autofocus: true,
                controller: _controller,
                decoration: const InputDecoration(hintText: "Your email adress..."),
              ),
              TextButton(
                onPressed: () {
